...
class Products(models.Model):
    ...
    product_usage = models.CharField(max_length=250, default='', blank=True)
    product_description = models.TextField(default='', blank=True)
    product_longDescription = models.TextField(default='', blank=True)
    product_activeIngredient = models.TextField(default='', blank=True)
